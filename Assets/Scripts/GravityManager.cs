...
public class GravityManager : MonoBehaviour
{
    ...
    public bool verif_collision2(RaycastHit2D ray, float condition_distance, bool selonX)
    {
        if (selonX)
        {
    ...
    public bool isSmashed()
    {
        ...
        if ((verif_collision2(ray_collide_right_u, sprite_width/2, true) || verif_collision2(ray_collide_left_u, sprite_width / 2, true))
        && (verif_collision2(ray_collide_right_d, sprite_width / 2, true) || verif_collision2(ray_collide_left_d, sprite_width / 2, true) ) )
        {
            Debug.Log("isSmashed - droite/gauche");
            this.transform.position = spawn_position;
            return true;
        }

        //Collision haut-bas
        if( (verif_collision2(ray_collide_up_l, sprite_height/2, false) || verif_collision2(ray_collide_up_l, sprite_height/2, false) )
        && (verif_collision2(ray_collide_down_r, (sprite_height/2), false) || verif_collision2(ray_collide_down_r, (sprite_height/2), false) ) )
        {
            Debug.Log("isSmashed - haut/bas");
            this.transform.position = spawn_position;
            return true;
        }
        return false;
